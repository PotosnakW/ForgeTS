...
def forecasting(
    ...
    dataset_names: str = '/zfsauton/project/public/Mononito/TimeseriesDatasets/forecasting/autoformer/electricity.csv'
) -> None:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_names', 
        ...
        default='/zfsauton/project/public/Mononito/TimeseriesDatasets/forecasting/autoformer/electricity.csv')
